  ...
  <div class="container-fluid">
    <div class="row about-card">
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 about-column">
        <h4 style="font-weight: 700; margin-bottom: 2rem;">İletişim</h4>
        <form action="iletisim-detay.php" method="POST">
          <div class="form-group">
            <label>Email</label>
            <input type="email" class="form-control" placeholder="Email" id="emailForm" name="email"/>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Mesaj</label>
            <input type="text" class="form-control" placeholder="Mesajınız" name="message"/>
          </div>
          <button type="submit" class="btn btn-dark" name="Upload">Gönder</button>
          <button type="button" class="btn btn-danger" id="clearForm">Temizle</button>
        </form>
      </div>
    </div>
    <div id="goToTop">
